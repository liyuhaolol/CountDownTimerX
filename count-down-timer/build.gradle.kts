...
centralPortal {
    ...
    pom {
        ...
        url = "https://github.com/liyuhaolol/CountDownTimerX"
        licenses {
            license {
                name = "The MIT License"
                url = "https://github.com/liyuhaolol/CountDownTimerX/blob/master/LICENSE"
            }
        }
        developers {
            developer {
        ...
        scm {
            connection = "scm:git@github.com/liyuhaolol/CountDownTimerX.git"
            developerConnection = "scm:git@github.com/liyuhaolol/CountDownTimerX.git"
            url = "https://github.com/liyuhaolol/CountDownTimerX"
        }
